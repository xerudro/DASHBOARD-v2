...
func Servers(user *models.User, data ServersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/pages/servers.templ`, Line: 226, Col: 119}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var7))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "</span></div></div><h3 class=\"font-semibold text-gray-900 dark:text-white mb-2\">Web Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Hosts websites and web applications</p><div class=\"text-sm text-gray-500 dark:text-gray-500 mt-4\">No servers assigned</div></div><!-- Database Card --><div class=\"bg-white dark:bg-dark-800 border border-gray-300 dark:border-dark-600 rounded-xl p-6 hover:shadow-lg dark:hover:shadow-lg transition-all\"><div class=\"flex items-start justify-between mb-3\"><div class=\"w-10 h-10 bg-purple-100 dark:bg-purple-900/40 rounded-lg flex items-center justify-center\"><i data-lucide=\"database\" class=\"w-5 h-5 text-purple-600 dark:text-purple-400\"></i></div><div class=\"w-8 h-8 rounded-full bg-gray-200 dark:bg-dark-700 flex items-center justify-center\"><span class=\"text-sm font-bold text-gray-900 dark:text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/pages/servers.templ`, Line: 241, Col: 118}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var8))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</span></div></div><h3 class=\"font-semibold text-gray-900 dark:text-white mb-2\">Database</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Manages database operations</p><div class=\"text-sm text-gray-500 dark:text-gray-500 mt-4\">No servers assigned</div></div><!-- Mail Server Card --><div class=\"bg-white dark:bg-dark-800 border border-gray-300 dark:border-dark-600 rounded-xl p-6 hover:shadow-lg dark:hover:shadow-lg transition-all\"><div class=\"flex items-start justify-between mb-3\"><div class=\"w-10 h-10 bg-green-100 dark:bg-green-900/40 rounded-lg flex items-center justify-center\"><i data-lucide=\"mail\" class=\"w-5 h-5 text-green-600 dark:text-green-400\"></i></div><div class=\"w-8 h-8 rounded-full bg-gray-200 dark:bg-dark-700 flex items-center justify-center\"><span class=\"text-sm font-bold text-gray-900 dark:text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/pages/servers.templ`, Line: 256, Col: 120}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var9))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</span></div></div><h3 class=\"font-semibold text-gray-900 dark:text-white mb-2\">Mail Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Handles email services</p><div class=\"text-sm text-gray-500 dark:text-gray-500 mt-4\">No servers assigned</div></div><!-- Backup Server Card --><div class=\"bg-white dark:bg-dark-800 border border-gray-300 dark:border-dark-600 rounded-xl p-6 hover:shadow-lg dark:hover:shadow-lg transition-all\"><div class=\"flex items-start justify-between mb-3\"><div class=\"w-10 h-10 bg-orange-100 dark:bg-orange-900/40 rounded-lg flex items-center justify-center\"><i data-lucide=\"hard-drive\" class=\"w-5 h-5 text-orange-600 dark:text-orange-400\"></i></div><div class=\"w-8 h-8 rounded-full bg-gray-200 dark:bg-dark-700 flex items-center justify-center\"><span class=\"text-sm font-bold text-gray-900 dark:text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/pages/servers.templ`, Line: 271, Col: 122}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var10))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "</span></div></div><h3 class=\"font-semibold text-gray-900 dark:text-white mb-2\">Backup Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Manages backup operations</p><div class=\"text-sm text-gray-500 dark:text-gray-500 mt-4\">No servers assigned</div></div></div><!-- Role Distribution Summary --><div class=\"bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700/50 rounded-xl p-6\"><h2 class=\"text-xl font-semibold text-gray-900 dark:text-white mb-6\">Role Distribution Summary</h2><div class=\"flex flex-col gap-4\"><!-- Web Server Summary --><div class=\"flex items-center gap-4 p-4 border border-gray-200 dark:border-dark-600/50 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700/30 transition-all\"><div class=\"w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center flex-shrink-0\"><i data-lucide=\"globe\" class=\"w-5 h-5 text-blue-600 dark:text-blue-400\"></i></div><div class=\"flex-1\"><h3 class=\"font-semibold text-gray-900 dark:text-white\">Web Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Hosts websites and web applications</p></div><span class=\"text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap\">0/0 online</span></div><!-- Database Summary --><div class=\"flex items-center gap-4 p-4 border border-gray-200 dark:border-dark-600/50 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700/30 transition-all\"><div class=\"w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center flex-shrink-0\"><i data-lucide=\"database\" class=\"w-5 h-5 text-purple-600 dark:text-purple-400\"></i></div><div class=\"flex-1\"><h3 class=\"font-semibold text-gray-900 dark:text-white\">Database</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Manages database operations</p></div><span class=\"text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap\">0/0 online</span></div><!-- Mail Server Summary --><div class=\"flex items-center gap-4 p-4 border border-gray-200 dark:border-dark-600/50 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700/30 transition-all\"><div class=\"w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center flex-shrink-0\"><i data-lucide=\"mail\" class=\"w-5 h-5 text-green-600 dark:text-green-400\"></i></div><div class=\"flex-1\"><h3 class=\"font-semibold text-gray-900 dark:text-white\">Mail Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Handles email services</p></div><span class=\"text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap\">0/0 online</span></div><!-- Backup Server Summary --><div class=\"flex items-center gap-4 p-4 border border-gray-200 dark:border-dark-600/50 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700/30 transition-all\"><div class=\"w-10 h-10 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center flex-shrink-0\"><i data-lucide=\"hard-drive\" class=\"w-5 h-5 text-orange-600 dark:text-orange-400\"></i></div><div class=\"flex-1\"><h3 class=\"font-semibold text-gray-900 dark:text-white\">Backup Server</h3><p class=\"text-sm text-gray-600 dark:text-gray-400\">Manages backup operations</p></div><span class=\"text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap\">0/0 online</span></div></div></div></div><!-- Migration Tab --><div x-show=\"roleTab === 'migration'\" x-cloak><div class=\"bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700/50 rounded-xl p-8 text-center\"><i data-lucide=\"move\" class=\"w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4\"></i><h3 class=\"text-xl font-semibold text-gray-900 dark:text-white mb-3\">Server Role Migration</h3><p class=\"text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto\">Migrate server roles between different servers to optimize your infrastructure.</p><button class=\"inline-flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors font-medium\"><i data-lucide=\"plus\" class=\"w-5 h-5\"></i> <span>Start Migration</span></button></div></div><!-- Configuration Tab --><div x-show=\"roleTab === 'configuration'\" x-cloak><div class=\"bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700/50 rounded-xl p-8 text-center\"><i data-lucide=\"settings\" class=\"w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4\"></i><h3 class=\"text-xl font-semibold text-gray-900 dark:text-white mb-3\">Role Configuration</h3><p class=\"text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto\">Configure role-specific settings and policies for your server infrastructure.</p><button class=\"inline-flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors font-medium\"><i data-lucide=\"settings\" class=\"w-5 h-5\"></i> <span>Configure Roles</span></button></div></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
